...
augroup source-file
	autocmd!
	autocmd BufWritePost ~/racine/config/edit/vim-mail/after/syntax/** source %
	autocmd BufWritePost ~/racine/config/edit/vim-mail/autoload/** source %
	autocmd BufWritePost ~/racine/public/wheel/autoload/**.vim source %
	autocmd BufWritePost ~/racine/public/organ/autoload/**.vim source %
	autocmd BufWritePost ~/racine/config/edit/vim-mail/colors/ornuit.vim colorscheme ornuit
augroup END
