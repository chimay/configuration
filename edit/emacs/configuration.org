...
#+begin_src emacs-lisp
  ...
  (defconst custom/autosave-dir
   (concat (getenv "HOME") "/racine/varia/autosave/emacs/"))
  (setq auto-save-list-file-prefix custom/autosave-dir)
  (setq auto-save-file-name-transforms `((".*" ,custom/autosave-dir t)))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (defvar custom/terminal-shell "/bin/bash")

  (defadvice ansi-term (before force-bash)
    (interactive (list custom/terminal-shell)))
...
#+begin_src emacs-lisp
  (defun custom/edite-configuration-org ()
    (interactive)
...
#+begin_src emacs-lisp
  (defun custom/recharge-configuration-org ()
...
#+begin_src emacs-lisp
  (defun custom/affiche-copie-nom-fichier ()
    (interactive)
...
#+begin_src emacs-lisp
  (defun custom/debut-fin-fichier ()
    (interactive)
...
#+begin_src emacs-lisp
  (defun custom/demi-page-bas ()
    "scroll down half the page"
    (interactive)
    (scroll-up (/ (window-body-height) 2)))

  (defun custom/demi-page-haut ()
...
#+begin_src emacs-lisp
  (defun custom/efface-jusque-debut-ligne ()
  (interactive)
  (kill-line 0))
#+end_src
...
#+begin_src emacs-lisp
  (defun custom/efface-contenu-ligne ()
    (interactive)
    (beginning-of-line)
    (kill-line))
#+end_src
...
#+begin_src emacs-lisp
  (defun custom/copie-jusque-debut-ligne ()
    (interactive)
    (save-excursion
...
#+begin_src emacs-lisp
  (defun custom/copie-jusque-fin-ligne ()
    (interactive)
    (save-excursion
      (kill-new (buffer-substring
		 (point)
...
#+begin_src emacs-lisp
  (defun custom/copie-contenu-ligne ()
    (interactive)
    (save-excursion
      (kill-new
...
#+begin_src emacs-lisp
  (defun custom/alterne-deux-derniers-tampons ()
...
#+begin_src emacs-lisp
  (defun custom/ferme-tampon-courant ()
...
#+begin_src emacs-lisp
  (defun custom/ferme-tous-les-tampons ()
...
#+begin_src emacs-lisp
  (defun custom/revert-all-buffers ()
...
#+begin_src emacs-lisp
  (defun custom/aller-au-tampon-scratch ()
    (interactive)
    (switch-to-buffer "*scratch*"))

  (defun custom/aller-au-tampon-grenier ()
    (interactive)
    (split-window-right)
    (other-window 1)
    (find-file "Grenier")
...
(defun custom/scinde-et-suit-horizontalement ()
  (interactive)
  (split-window-below)
  (balance-windows)
  (other-window 1))

(defun custom/scinde-et-suit-verticalement ()
  (interactive)
  (split-window-right)
  (balance-windows)
  (other-window 1))
...
#+begin_src emacs-lisp
  (defun custom/insertion-date () (interactive)
...
(defun custom/insertion-date-jour () (interactive)
...
(defun custom/insertion-date-jour-heure () (interactive)
...
#+begin_src emacs-lisp
  (defun custom/style-sous-curseur ()
    (interactive)
...
(defun custom/lignes-vides-simples ()
...
(defun custom/lignes-doubles-avant-titres ()
...
#+begin_src emacs-lisp
  (global-set-key (kbd "<f5> e") 'custom/edite-configuration-org)
#+end_src

*** Recharger ce fichier

#+begin_src emacs-lisp
  (global-set-key (kbd "<f5> r") 'custom/recharge-configuration-org)
#+end_src
...
#+begin_src emacs-lisp
  (global-set-key (kbd "<f11> e") 'eval-buffer)
#+end_src
...
#+begin_src emacs-lisp
  (global-set-key [kp-prior] 'custom/demi-page-haut)
  (global-set-key [prior]    'custom/demi-page-haut)
  (global-set-key [kp-next]  'custom/demi-page-bas)
  (global-set-key [next]     'custom/demi-page-bas)
  ...
  (global-set-key (kbd "C-$")  'custom/debut-fin-fichier)
#+end_src
...
#+begin_src emacs-lisp
  (global-set-key (kbd "<S-delete>") 'custom/efface-mot)
  (global-set-key (kbd "<M-delete>") 'custom/efface-contenu-ligne)
  (global-set-key (kbd "<C-delete>") 'kill-whole-line)
  ;; Rappelle le C-u de Unix
  (global-set-key (kbd "s-u") 'custom/efface-jusque-debut-ligne)
  ;; (global-set-key (kbd "C-k") 'kill-line)
  (global-set-key (kbd "<C-backspace>") 'backward-kill-word)
  (global-set-key (kbd "<M-backspace>") 'custom/efface-mot)
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<S-insert>") 'custom/copie-mot)
  (global-set-key (kbd "<M-insert>") 'custom/copie-contenu-ligne)
  (global-set-key (kbd "<C-insert>") 'custom/copie-ligne)
  ;; Rappelle le C-u de Unix
  (global-set-key (kbd "s-U") 'custom/copie-jusque-debut-ligne)
  (global-set-key (kbd "<C-S-insert>") 'custom/copie-jusque-fin-ligne)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<s-kp-2>") 'custom/scinde-et-suit-horizontalement)
  (global-set-key (kbd "<s-kp-3>") 'custom/scinde-et-suit-verticalement)
...
#+begin_src emacs-lisp
  (global-set-key (kbd "C-^") 'custom/alterne-deux-derniers-tampons)
...
#+begin_src emacs-lisp
  (global-set-key (kbd "<f11> r") 'revert-buffer)
  (global-set-key (kbd "<f11> R") 'custom/revert-all-buffers)
#+end_src
...
#+begin_src emacs-lisp
  (global-set-key (kbd "C-x k") 'custom/ferme-tampon-courant)
#+end_src
...
#+begin_src emacs-lisp
  (global-set-key (kbd "C-M-s-k") 'custom/ferme-tous-les-tampons)
#+end_src
...
#+begin_src emacs-lisp
  (global-set-key (kbd "<f11> c") 'clean-buffer-list)
#+end_src
...
#+begin_src emacs-lisp
  (global-set-key (kbd "<f11> s") 'custom/aller-au-tampon-scratch)
  (global-set-key (kbd "<f11> g") 'custom/aller-au-tampon-grenier)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<f11> n") 'custom/affiche-copie-nom-fichier)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "s-y") 'custom/copie-sexp)
...
#+begin_src emacs-lisp
  (global-set-key (kbd "s-d") 'custom/insertion-date)
  (global-set-key (kbd "s-D") 'custom/insertion-date-jour)
#+end_src
...
#+begin_src emacs-lisp
  (global-set-key (kbd "s-l") 'linum-number-mode)
  (global-set-key (kbd "<f6> l") 'hl-line-mode)
#+end_src

Infos sur les thèmes

#+begin_src emacs-lisp
  (global-set-key (kbd "<f7> c") 'custom/style-sous-curseur)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package undo-tree
    :bind (("<f6> u" . global-undo-tree-mode)
...
#+begin_src emacs-lisp
  ...
  ;; (global-set-key (kbd "<f6> w") 'evil-org-mode)
#+end_src
