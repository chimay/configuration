...
(use-package org-alert
  :after (org)
  :custom ((org-alert-interval 3600)
	   (org-alert-headline-regexp "\\(Sched.+:.+\\|Deadline:.+\\)"))
  :config
  (org-alert-enable))
...
(use-package torus
  ...
  :bind (("<s-insert>" . torus-add-here)
	 ...
	 ("<M-prior>" . torus-previous-location)
	 ("<M-next>" . torus-next-location)
	 ("<C-prior>" . torus-previous-circle)
	 ("<C-next>" . torus-next-circle)
	 ("<S-prior>" . torus-previous-torus)
	 ("<S-next>" . torus-next-torus)
	 ("s-SPC" . torus-switch-location)
	 ("s-=" . torus-switch-circle)
	 ("s-µ" . torus-switch-torus)
	 ("s-x" . torus-search-location)
	 ("s-?" . torus-search-location-in-torus)
	 ("s-/" . torus-search-circle)
	 ("s-c" . torus-search-circle)
	 ("s-h" . torus-browse-history)
	 ("<M-home>" . torus-newer)
	 ("<M-end>" . torus-older)
	 ("C-^" . torus-alternate)
