...
augroup source-file
	autocmd!
	autocmd BufWritePost ~/racine/config/edit/neovim-lite/after/syntax/** source %
	autocmd BufWritePost ~/racine/config/edit/neovim-lite/autoload/** source %
	autocmd BufWritePost ~/racine/public/wheel/autoload/**.vim source %
	autocmd BufWritePost ~/racine/public/organ/autoload/**.vim source %
	autocmd BufWritePost ~/racine/config/edit/neovim-lite/colors/ornuit.vim colorscheme ornuit
augroup END
...
augroup file-music
	" see ~/racine/config/edit/neovim-lite/after/ftplugin/lilypond.vim
...
" ---- not needed anymore, see  <url:~/racine/config/edit/neovim-lite/colors/golden-night.vim#tn=treesitter>
