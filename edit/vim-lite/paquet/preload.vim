...
if ! exists("g:wheel_loaded")
	...
	let g:wheel_config.storage.wheel.folder = '~/racine/plugin/data/vim-lite/wheel'
	...
	let g:wheel_config.storage.session.folder = '~/racine/plugin/data/vim-lite/wheel/session'
