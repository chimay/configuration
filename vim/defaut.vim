...
" Fichiers dont une marque est présente dansviminfo
...
nnoremap <silent> <C-l> :noh<CR>zz2<C-e><C-l>
...
"call bibliotheque#sourceRepertoire('~/racine/config/edit/vim/types2fichiers')
