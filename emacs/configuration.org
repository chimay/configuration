...
(defun perso/edite-configuration-org ()
  (interactive)
...
(defun perso/recharge-configuration-org ()
...
(defun perso/copie-jusque-fin-ligne ()
 "Copie jusqu’à la fin de la ligne"
 (interactive)
 (kill-line)
 (undo-boundary)
...
(defun perso/efface-contenu-ligne ()
...
(defun perso/efface-jusque-debut-ligne ()
...
(defun perso/affiche-nom-fichier ()
...
(defun perso/supprime-tampon-courant ()
...
(defun perso/scinde-et-suit-horizontalement ()
  (interactive)
  (split-window-below)
  (balance-windows)
  (other-window 1))

(defun perso/scinde-et-suit-verticalement ()
  (interactive)
  (split-window-right)
  (balance-windows)
  (other-window 1))
...
(defun perso/insertion-date () (interactive)
...
(defun perso/insertion-date-jour () (interactive)
...
(defun perso/insertion-date-jour-heure () (interactive)
...
(defun perso/lignes-vides-simples ()
...
(defun perso/lignes-doubles-avant-titres ()
...
(global-set-key (kbd "<f5> e") 'perso/edite-configuration-org)
...
(global-set-key (kbd "<f5> r") 'perso/recharge-configuration-org)
...
(global-set-key (kbd "<M-backspace>") 'perso/efface-mot)
...
(global-set-key (kbd "<C-insert>")   'perso/copie-ligne)

(global-set-key (kbd "<M-insert>")   'perso/copie-jusque-fin-ligne)

(global-set-key (kbd "<C-delete>")   'perso/efface-contenu-ligne)

(global-set-key (kbd "<M-delete>")   'perso/efface-jusque-debut-ligne)
...
(global-set-key (kbd "<s-kp-2>") 'perso/scinde-et-suit-horizontalement)
(global-set-key (kbd "<s-kp-3>") 'perso/scinde-et-suit-verticalement)
...
(global-set-key [f6] 'perso/affiche-nom-fichier)
...
(global-set-key (kbd "C-^") 'perso/tampon-precedent)
...
*** Supprimer le tampon courant

#+begin_src emacs-lisp

(global-set-key (kbd "C-x k") 'perso/supprime-tampon-courant)
...
(defvar perso/terminal-shell "/bin/bash")

(defadvice ansi-term (before force-bash)
  (interactive (list perso/terminal-shell))
)
...
(global-set-key (kbd "s-d") 'perso/insertion-date)
(global-set-key (kbd "s-D") 'perso/insertion-date-jour)
...
(global-set-key (kbd "C-c s-a") (lambda () (interactive) (insert "⟻")))
(global-set-key (kbd "C-c s-z") (lambda () (interactive) (insert "⟼")))

(global-unset-key (kbd "<f9>"))

(global-set-key (kbd "<f9> SPC") (lambda () (interactive) (insert " ")))
...
(global-set-key (kbd "<home>") 'mtorus-cycle-marker-previous)
(global-set-key (kbd "<end>") 'mtorus-cycle-marker-next)

(global-set-key (kbd "s-t N") 'mtorus-cycle-ring-next)
(global-set-key (kbd "s-t P") 'mtorus-cycle-ring-previous)

(global-set-key (kbd "<S-home>") 'mtorus-cycle-ring-previous)
(global-set-key (kbd "<S-end>") 'mtorus-cycle-ring-next)
