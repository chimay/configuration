...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<C-M-insert>")   'biblio/copie-ligne)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<f5> s") (lambda () (interactive)
				   (switch-to-buffer "*scratch*")))

  (global-set-key (kbd "<f5> g") (lambda () (interactive)
				   (find-file-noselect "./Grenier")
				   (switch-to-buffer "Grenier" )))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<s-kp-enter>") 'eshell)
...
(global-set-key (kbd "<f6> g") 'ggtags-mode)
