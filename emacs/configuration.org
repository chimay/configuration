...
(define-key region-bindings-mode-map (kbd "s-m") 'mc/mark-next-like-this)
...
(key-chord-define-global "wi" 'delete-other-windows)
(key-chord-define-global "wu" 'split-window-below)
(key-chord-define-global "wo" 'split-window-right)
