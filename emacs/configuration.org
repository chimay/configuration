...
;; Voir smartparens dans paquet-config.el
...
Ensuite :
  ...
  - Le texte inséré se place à gauche ou à droite du rectangle, suivant la
  position du curseur
  - C-2 M-w sauve le texte dans le registre 2
  - C-S-<SPC> place une marque globale où tous les textes copiés seront
  ajoutés

Voir [[*Bindings][les bindings]]
