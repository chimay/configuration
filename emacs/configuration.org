...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "s-£") 'org-graph-view)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<f11> u") 'global-undo-tree-mode)
#+end_src
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<f11> c") 'key-chord-mode)
#+end_src
...
#+begin_src emacs-lisp
  (use-package evil)
  (global-set-key (kbd "<f11> v") 'evil-mode)
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "<f11> x") 'xah-math-input-mode)
#+end_src
