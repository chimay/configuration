...
local home = os.getenv("HOME")
local xpm_path = home .. "/racine/plugin/manager/xplr/xpm/dtomvan/xpm.xplr"
...
require("xpm").setup({
    plugins = {
        ...
        'dtomvan/xpm.xplr',
        -- setup : see below in separate folders
        {
...
require("tri-pane").setup({
  -- millerview
  layout_key = "m", -- In switch_layout mode
...
map.setup{
  mode = "default",  -- or `xplr.config.modes.builtin.default`
  key = "M",
  editor = os.getenv("EDITOR") or "vim-lite.sh",
  editor_key = "ctrl-o",
