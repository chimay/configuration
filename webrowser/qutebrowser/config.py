...
## unlimited
## Type: Int
c.completion.cmd_history_max_items = 84000
...
## Type: Int
c.downloads.remove_finished = 12000
...
## Type: Padding
c.tabs.indicator.padding = {'top': 3, 'bottom': 3, 'left': 5, 'right': 5}
...
c.url.default_page = 'https://northboot.xyz/'
...
c.url.searchengines = {
    ...
    "bi": 'https://search.brave.com/images?q={}',
    "ddg": 'https://duckduckgo.com/?q={}',
    "dp": 'https://www.dogpile.com/serp?q={}',
    "dw": 'https://distrowatch.com/table.php?distribution={}',
    "gh":  'https://github.com/search?q={}',
    "ghu": 'https://github.com/search?q=user%3A{}',
    "it": 'https://infotiger.com/search?query={}',
    "ls": 'https://search.lookseek.com/searchls.php?q={}',
    "mg": 'https://metager.org/meta/meta.ger3?eingabe={}',
    "mgn": 'https://search.marginalia.nu/search?query={}',
    "mj": 'https://www.mojeek.com/search?q={}',
    "qr": 'https://quickref.me/{}',
    "qwl": 'https://lite.qwant.com/?q={}',
    "se": 'https://stackexchange.com/search?q={}',
    "sms": 'https://searchmysite.net/search/?q={}',
    "sp": 'https://spot.ecloud.global/search?q={}',
    "sx": 'https://searx.org/search?q={}',
    "sxi": 'https://searx.org/search?q={}&category_images=on',
    "wb": 'https://www.wiby.me/?q={}',
    "wp": 'https://en.wikipedia.org/wiki/Special:Search?search={}',
    "wpfr": 'https://fr.wikipedia.org/w/index.php?search={}',
    "wt": 'https://en.wiktionary.org/wiki/{}',
    "wtfr": 'https://fr.wiktionary.org/wiki/{}',
    "yc": 'https://yacy.eskimo.com/yacysearch.html?query={}',
}
...
## Background color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #222222, stop:1 #101010)'
...
## Foreground color of completion widget category headers.
## Type: QtColor
c.colors.completion.category.fg = '#5b3c11'
...
## Type: QtColor
c.colors.completion.fg = '#5b3c11'

## Background color of the selected completion item.
## Type: QssColor
c.colors.completion.item.selected.bg = '#5b3c11'
...
## Type: QssColor
c.colors.completion.scrollbar.fg = '#5b3c11'
...
## Color gradient start for download text.
## Type: QtColor
c.colors.downloads.start.fg = '#5b3c11'
...
## Color gradient end for download text.
## Type: QtColor
c.colors.downloads.stop.fg = '#5b3c11'
...
## Type: QssColor
c.colors.messages.info.fg = 'green'
...
## Foreground color of the statusbar in caret mode.
## Type: QssColor
c.colors.statusbar.caret.fg = '#5b3c11'
...
## Foreground color of the statusbar in caret mode with a selection.
## Type: QssColor
c.colors.statusbar.caret.selection.fg = '#5b3c11'
...
## Foreground color of the statusbar in command mode.
## Type: QssColor
c.colors.statusbar.command.fg = '#5b3c11'
...
## Foreground color of the statusbar.
## Type: QssColor
c.colors.statusbar.normal.fg = '#5b3c11'
...
## Default foreground color of the URL in the statusbar.
## Type: QssColor
c.colors.statusbar.url.fg = '#5b3c11'

## Foreground color of the URL in the statusbar for hovered links.
## Type: QssColor
c.colors.statusbar.url.hover.fg = '#5b3c11'

## Foreground color of the URL in the statusbar on successful load
## (http).
## Type: QssColor
c.colors.statusbar.url.success.http.fg = '#5b3c11'

## Foreground color of the URL in the statusbar on successful load
## (https).
## Type: QssColor
c.colors.statusbar.url.success.https.fg = '#5b3c11'
...
c.colors.tabs.indicator.start = '#3b3c11'

## Color gradient end for the tab indicator.
## Type: QtColor
# c.colors.tabs.indicator.stop = 'black'
c.colors.tabs.indicator.stop = '#7b3c11'
...
c.colors.tabs.selected.odd.bg = '#a9421d'
...
val_0 = "['']"
val_1 = "['stylesheet/golden-night.css']"
val_2 = "['stylesheet/solarized-dark-all-sites.css']"
values = val_0 + ' ' + val_1 + ' ' + val_2

config.bind("<alt-f1>", 'cmd-set-text -s :help -t')
config.bind('<alt-f5>', 'config-source')
config.bind('<alt-f6>', 'adblock-update')
config.bind('<alt-f7>', "config-cycle content.user_stylesheets " + values)

config.bind("<f1>", 'cmd-set-text -s :open -t -r sxi')
config.bind("<f2>", 'cmd-set-text -s :open -t -r sp')
config.bind("<f3>", 'cmd-set-text -s :open -t -r mj')
config.bind("<f4>", 'cmd-set-text -s :open -t -r yc')
config.bind("<f5>", 'cmd-set-text -s :open -t -r mgn')
config.bind("<f6>", 'cmd-set-text -s :open -t -r it')
config.bind("<f7>", 'cmd-set-text -s :open -t -r wb')
config.bind("<f8>", 'cmd-set-text -s :open -t -r ff')
config.bind("<f9>", 'cmd-set-text -s :open -t -r sms')
config.bind("<f10>", 'cmd-set-text -s :open -t -r qwl')

config.bind("<control-f1>", 'cmd-set-text -s :open -t -r b')
config.bind("<control-f2>", 'cmd-set-text -s :open -t -r bi')
config.bind("<control-f3>", 'cmd-set-text -s :open -t -r dp')
config.bind("<control-f4>", 'cmd-set-text -s :open -t -r mg')
config.bind("<control-f5>", 'cmd-set-text -s :open -t -r yh')
config.bind("<control-f6>", 'cmd-set-text -s :open -t -r fs')
config.bind("<control-f7>", 'cmd-set-text -s :open -t -r yx')

config.bind("<shift-f1>", 'open -t -r https://www.meteo.be/fr/')
config.bind("<shift-f2>", 'open -t -r https://www.accuweather.com/en/be/ottignies/27242/daily-weather-forecast/27242')
config.bind("<shift-f3>", 'open -t -r https://www.meteociel.fr/')
config.bind("<shift-f4>", 'open -t -r https://climatereanalyzer.org/')

config.bind("<shift-f5>", 'open -t -r https://www.ecmwf.int/')
config.bind("<shift-f6>", 'open -t -r https://www.tropicaltidbits.com/sat/')
config.bind("<shift-f7>", 'open -t -r https://meteologix.com/be/radar-hd/france')
config.bind("<shift-f8>", 'open -t -r https://earth.nullschool.net/')

config.bind("<shift-f9>", 'open -t -r https://www.windy.com/-Rain-thunder-rain')
config.bind("<shift-f10>", 'open -t -r https://www.ventusky.com/?w=off')
config.bind("<shift-f11>", 'open -t -r https://zoom.earth/')

# ---- other keys

config.bind('o', 'cmd-set-text -s :open -r -t')
config.bind('O', 'cmd-set-text -s :open -w')

config.bind('go', 'cmd-set-text :open {url:pretty}')
config.bind('gt', 'cmd-set-text :open -r -t {url:pretty}')
config.bind('gw', 'cmd-set-text :open -w {url:pretty}')

config.bind('ç', 'open -r -t -- {clipboard}')
config.bind('pp', 'open -r -t -- {clipboard}')
config.bind('pP', 'open -r -t -- {primary}')
...
config.bind('<Ins>', 'mode-enter insert')

config.bind('m', 'mode-enter set_mark')
config.bind('M', 'bookmark-add -t')
...
config.bind("è", 'spawn -u qutedmenu tab')

config.bind('%', 'quickmark-save')
config.bind("ù", 'cmd-set-text -s :quickmark-load -t')

config.bind("à", 'open -t -r file:///home/david/racine/refer/orgmode/bookmarks.html')
config.bind("°", 'cmd-set-text -s :bookmark-load -t')

config.bind("£", 'cmd-set-text -s :session-save -o')
config.bind("µ", 'cmd-set-text -s :session-load')
config.bind("é", 'cmd-set-text -s :session-load')
config.bind("è", 'cmd-set-text -s :session-save -o')
...
config.bind('<F2>', 'edit-text', mode='insert')

# config.bind('<Ctrl-E>', 'open-editor', mode='insert')
# config.bind('<Escape>', 'leave-mode', mode='insert')
# config.bind('<Shift-Ins>', 'insert-text {primary}', mode='insert')

config.bind('<control-pgup>', 'tab-prev', mode = 'insert')
config.bind('<control-pgdown>', 'tab-next', mode = 'insert')
