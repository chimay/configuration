...
command! PackUpdate packadd minpac | source ~/racine/config/edit/neovim/init.vim | call minpac#update()
command! PackClean  packadd minpac | source ~/racine/config/edit/neovim/init.vim | call minpac#clean()
