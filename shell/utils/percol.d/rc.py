...
percol.view.PROMPT = "percol : %q"
percol.view.RPROMPT = "(%n/%N) [%i/%I]"
...
percol.import_keymap({
    ...
    "M-a"   : lambda percol : percol.command.toggle_mark_all(),
...
percol.view.CANDIDATES_LINE_SELECTED = ("reverse", "on_default", "default")
percol.view.CANDIDATES_LINE_MARKED   = ("bold", "on_default", "default")
percol.view.CANDIDATES_LINE_QUERY    = ("on_default", "default")
